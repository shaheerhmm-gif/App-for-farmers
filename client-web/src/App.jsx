  ...
  if (loading) {
    return (
      <div className="splash-screen">
        ...
        <h1 className="splash-title">Khet Bandhu</h1>
        <div className="splash-loader" />
      </div>
    );
  }

  if (!user) return <LoginPage onLogin={(type) => setUser(type)} />;
  if (user === 'customer') return <CustomerApp onLogout={() => setUser(null)} />;
  return <OwnerApp onLogout={() => setUser(null)} />;
}
